...
<div class="smart-filter  mb-4 <?= $templateData["TEMPLATE_CLASS"] ?> <?
	if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "smart-filter-horizontal" ?>">
	<div class="smart-filter-section">
		...
		<form name="<?
			...
			echo $arResult["FORM_ACTION"] ?>" method="get" class="smart-filter-form">
				...
				<?
					foreach ($arResult["ITEMS"] as $key => $arItem)//prices
					{
						...
						if (isset($arItem["PRICE"])):
							...
							<div class="<?
								if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<?
								else: ?>col-12<?
								endif ?> mb-2 smart-filter-parameters-box bx-active">
					...
					foreach ($arResult["ITEMS"] as $key => $arItem) {
						...
						<div class="<?
							...
							endif ?> mb-2 smart-filter-parameters-box <?
							...
							<div class="smart-filter-parameters-box-title"
								...
								<span data-role="prop_angle"
											class="smart-filter-angle smart-filter-angle-<?
												if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>up<?
												else: ?>down<?
												endif ?>">
								<span class="smart-filter-angles"></span>
							</span>
								...
								<div class="smart-filter-parameters-box-container">
									<?
										...
										<?
											...
											<div class="smart-filter-input-group-dropdown">
												<div class="smart-filter-dropdown-block"
													...
													<div class="smart-filter-dropdown-popup"
													...
													<div class="smart-filter-input-group-dropdown-flex"
														...
														<?
															...
															if (!$checkedItemExist) {
																...
																<span class="smart-filter-dropdown-text"><?= GetMessage(
																		"CT_BCSF_FILTER_ALL"
																	); ?></span>
																<?
															}
										...
										?>
											<div class="col">
												<div class="radio">
													<label class="smart-filter-param-label" for="<?
														echo "all_" . $arCur["CONTROL_ID"] ?>">
							...
							<div class="smart-filter-popup-result <?
								...
								<?
									echo GetMessage(
										...
										array(
											"#ELEMENT_COUNT#" => '<span id="modef_num">' . intval(
...
<script type="text/javascript">
	var smartFilter = new JCSmartFilter('<?echo CUtil::JSEscape(
		$arResult["FORM_ACTION"]
	)?>', '<?=CUtil::JSEscape($arParams["FILTER_VIEW_MODE"])?>', <?=CUtil::PhpToJSObject(
